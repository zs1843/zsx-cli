        ...
        case 'page':
            ...
            fs.pathExists(pageFile, (err, exists) => {
                if (exists) {
                    ...
                    fs.copy('/demo/my-cli/node_modules/vue-zsx-generate/src/template/page.vue', pageFile, err => {
                        if (err) return console.error(err)
                
                        console.log(pageFile + '  has created')
                    })
                    fs.copy('/demo/my-cli/node_modules/vue-zsx-generate/src/template/page.less', styleFile, err => {
                        if (err) return console.error(err)
        ...
        case 'component':
            ...
            fs.pathExists(componentFile, (err, exists) => {
                if (exists) {
                    ...
                    fs.copy('/demo/my-cli/node_modules/vue-zsx-generate/src/template/component.vue', componentFile, err => {
                        if (err) return console.error(err)
        ...
        case 'store':
            ...
            fs.pathExists(storeFile, (err, exists) => {
                if (exists) {
                    ...
                    fs.copy('/demo/my-cli/node_modules/vue-zsx-generate/src/template/store.js', storeFile, err => {
                        if (err) return console.error(err)
